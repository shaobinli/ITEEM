...
# df_nitrate = pd.read_excel(xls, 'Nitrate')
# df_TP = pd.read_excel(xls, 'Phosphorus')
# df_sediment = pd.read_excel(xls, 'Sediments')
# df_streamflow = pd.read_excel(xls, 'Water')

df_link = pd.read_excel(r'C:\ITEEM\Submodel_SWAT\Watershed_linkage_v2.xlsx')
df_SDD_nutrient = pd.read_csv(r'C:\ITEEM\Submodel_SWAT\results_validation\SDD_interpolated_2000_2018_Inputs.csv', 
                              parse_dates=['Date'], index_col='Date')
df_point_SDD = pd.read_csv(r'C:\ITEEM\Submodel_SWAT\results_validation\SDD_interpolated_2000_2018_Inputs.csv', 
                              parse_dates=['Date'], index_col='Date')

df_linkage = pd.read_excel(r'C:\ITEEM\Submodel_SWAT\Watershed_linkage.xlsx').fillna(0)
df_linkage2 = pd.read_excel(r'C:\ITEEM\Submodel_SWAT\Watershed_linkage_v2.xlsx')
df_landuse = pd.read_excel(r'C:\ITEEM\Submodel_SWAT\landuse.xlsx').fillna(0)
df_pd_coef_poly = pd.read_excel(r'C:\ITEEM\Submodel_SWAT\results_validation\sediment_streamflow_regression_coefs.xlsx', sheet_name='poly', usecols='B:D')
