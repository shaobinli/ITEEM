...
from Submodel_SWAT.SWAT_functions import get_yield
 
# load data again
# opt_vars = scipy.io.loadmat('opt_vars_s1.mat')['out']
# opt_vars_landuse = opt_vars[:50]



def plot_map(name, opt_landuse):
...
plot_map(name='sediment',opt_landuse=0)
end = time.time()
